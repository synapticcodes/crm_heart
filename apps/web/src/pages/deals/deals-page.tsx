...
import { DealFilters } from '@/widgets/deals-board/ui/deal-filters'
import { DealDrawer } from '@/widgets/deals-board/ui/deal-drawer'
import { DealsColumn } from '@/widgets/deals-board/ui/deals-column'
import { useDealsKanban } from '@/widgets/deals-board/model/use-deals-kanban'
import { DEAL_STATUS_LABELS, type DealRecord, type DealStatus } from '@/entities/deal/model'
