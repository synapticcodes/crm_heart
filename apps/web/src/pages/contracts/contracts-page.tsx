...
import { useContractTemplatesAdmin } from '@/entities/contract/lib/use-contract-templates-admin'
import type { ContractTemplate, ContractTemplateVariable } from '@/entities/contract/model'
