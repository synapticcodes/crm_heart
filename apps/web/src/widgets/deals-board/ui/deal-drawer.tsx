...
import { BRAZILIAN_STATES } from '@/entities/deal/model'
import type { DealRecord, ServiceRecord } from '@/entities/deal/model'
import { formatCEP, formatCPF, formatCurrency, formatPhone, formatRG, parseCurrency } from '@/entities/deal/lib/format'
import {
